...
# Issue 387 QueueExistsAsync is implemented
function Confirm-OpenStackCloudQueueExists {
    [CmdletBinding()]
	Param(
		[Parameter(Mandatory=$True)]
		[string] $Account = $(throw "-Account parameter is required."),
    ...
    try {
        ...
        # DEBUGGING       
        Write-Debug -Message "Confirm-OpenStackCloudQueueExists"
        Write-Debug -Message "Account...........: $Account" 
        Write-Debug -Message "UseInternalUrl....: $UseInternalUrl"
        Write-Debug -Message "RegionOverride....: $RegionOverride"
		...
		$Provider.QueueExistsAsync($qn, $CancellationToken).Result
    }
    catch {
        Invoke-Exception($_.Exception)
    }
